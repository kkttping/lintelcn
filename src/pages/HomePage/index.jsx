                    ...
                    ? activtyKey === index &&
                      item?.video && (
                        <video
                          ...
                          autoPlay={true}
                          muted
                          src={ConstValue.url + "assets/" + item?.video}
                        ></video>
                      )
                    : activtyKey === index &&
                      item?.img && (
                        <div
                          ...
                          style={{
                            backgroundImage: `url(${
                              ConstValue.url + "assets/" + item?.img
                            })`,
                          }}
                        >
                          {item?.icon && (
                            <div
                              ...
                              style={{
                                backgroundImage: `url(${
                                  ConstValue.url + "assets/" + item?.icon
                                })`,
                              }}
                            ></div>
                          )}
              ...
              return (
                ...
                >
                  <div
                    className={
                      "title_name " +
                      (activtyKey === index ? "activtyitem" : "")
                    }
                  >
                    {item.menu} <div className="buttom"></div>{" "}
                  </div>
                </div>
              );
            })}
      ...
      <div className="content">
        <div className="event">
          <Parallax
            ...
            className="code-box-shape"
          >
            <div className="title_h1">Events</div>
            <Row justify={"center"}>
              <Col sm={24} xl={10}>
                <div className="infomation">
                  <div className="title">{newInfo?.Title}</div>
                  <div
                    className="info"
                    dangerouslySetInnerHTML={{
                      __html: newInfo?.Exhibition?.replace(/\n/g, "<br/>"),
                    }}
                  ></div>
                  <span
                    className="readmore"
...
>>>>>>> a7a4b34506043da47743c4dee5aecd4d179475f4
              ...
              <Col sm={24} xl={14}>
                <div className="img_info">
                  <div
                    ...
                    style={{
                      backgroundImage: `url(${
                        ConstValue.url + "assets/" + newImg
                      })`,
                    }}
                  >
                    <div className="time">
                      <span>
                        {new Date(newInfo?.date_created).getFullYear()}
                        <br />
                      </span>
                      <span>
                        {timeSet(new Date(newInfo?.date_created).getMonth())}-
                        {timeSet(new Date(newInfo?.date_created).getDay())}
                      </span>
                    </div>
                  </div>
                </div>
        ...
        <div className="leading" style={{ backgroundImage: `url(${img_bg2})` }}>
          A Solution and Service Provider <br /> of High Speed Optical I/O
          Connectivity
        </div>
        <div
          className="products_item"
          style={{ backgroundImage: `url(${img_bg3})` }}
        >
          <div className="title_h1">Products</div>
...
=======
          <div
            className={pFlag === 0 ? "act_img item_img" : "item_img"}
            style={{ backgroundImage: `url(${imgitem1})` }}
          ></div>
          <div
            className={pFlag === 1 ? "act_img item_img" : "item_img"}
            style={{ backgroundImage: `url(${imgitem2})` }}
          ></div>
          <div
            className={pFlag === 2 ? "act_img item_img" : "item_img"}
            style={{ backgroundImage: `url(${imgitem3})` }}
          ></div>
>>>>>>> a7a4b34506043da47743c4dee5aecd4d179475f4
          ...
          <Row justify={"center"}>
            <Col sm={24} xl={24} xxl={12}>
              <div className="infomation">
                <div
                  className={pFlag === 0 ? "title" : "titleb"}
                  onClick={() => setpFlag(0)}
                >
                ...
                <div
                  className={"info "}
                  style={pFlag === 0 ? { height: "5rem" } : {}}
                >
                  <a
                    style={{ color: "#6e6e6e" }}
                    href="http://www.linkteltech.com/index.php?r=product-category%2Findex#"
                  >
                    100G/400G/800G/1.6T EML/TFLN/Sipho OSFP/QSFP-DD
                  </a>
                </div>
                <div
                  className={pFlag === 1 ? "title" : "titleb"}
                  onClick={() => setpFlag(1)}
                >
                  Optical Engine
                  <div
                ...
                <div
                  className={"info "}
                  style={pFlag === 1 ? { height: "6rem" } : {}}
                >
                  <a
                    style={{ color: "#6e6e6e" }}
                    href="http://www.linkteltech.com/index.php?r=product-category%2Findex#"
                  >
                    n-house Design &amp; Manufacture 100G/λ and 200G/λ Optical
                    Engines with Cutting Edge OE Packaging Capabilities{" "}
                  </a>
                </div>
                <div
                  className={pFlag === 2 ? "title" : "titleb"}
                  onClick={() => setpFlag(2)}
                >
                ...
                <div
                  className={"info "}
                  style={pFlag === 2 ? { height: "5rem" } : {}}
                >
                  <a
                    style={{ color: "#6e6e6e" }}
                    href="http://www.linkteltech.com/index.php?r=product-category%2Findex#"
                  >
                    1.6T/3.2T NPO/CPO Optical Engines Optical/Electrical Hybrid
                    Packaging Platforms
                  </a>
                </div>
                {/* <div className='info2'>
