    ...
    <div className="home_page">
              ...
              >
                {activtyKey === 0 && (
                  <div
                    ...
                    style={{
                      backgroundImage: `url(${
                        ConstValue.url + "assets/" + info?.icon
                      })`,
                    }}
                  ></div>
                )}
              </div>
              <div className="botom_mask2"></div>
            </div>
            <div className="img_box">
              <video
                className="img_bg"
                ...
                autoPlay={true}
                muted
                src={ConstValue.url + "assets/" + info?.video}
              ></video>
            ...
            {selectArr.map((item, index) => {
              return (
                ...
                >
                  ...
                  >
                    {item.name} <div className="buttom"></div>{" "}
                  </div>
                </div>
              );
            })}
      ...
      <div className="content">
            ...
            <Row justify={"center"}>
              <Col sm={24} xl={10}>
                <div className="infomation">
                  ...
                  ></div>
                  <span className="morehover" onClick={() => {}}>READ MORE</span>
                </div>
              </Col>
              <Col sm={24} xl={14}>
        ...
        <div className="leading" style={{ backgroundImage: `url(${img_bg2})` }}>
          A Solution and Service Provider
          <br/>
           of High Speed Optical I/O Connectivity
        </div>
        <div
        ...
        >
          ...
          <div
            className="item_img"
            style={{ backgroundImage: `url(${img_item6})` }}
          ></div>
          <Row justify={"center"}>
            <Col sm={24} xl={24} xxl={12}>
              <div className="infomation">
                ...
                <div className="info">
                  Virtual product features are introduced, and more accurate
