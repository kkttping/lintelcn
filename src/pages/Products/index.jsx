...
export default function Products() {
    ...
    return (
        <div className='products'>
            <TopInfo imgBg={imgBg} title={'Products'} info1={'A Solution and Service'} info2={'Provider of High Speed Optical I/O Connectivity'} />

            <Row justify={"center"}>
                <Col xl={24} xxl={8} >
                    <div className='card_item'>
                        <CardProducts  link={toProducts2} img={imgitem1} info={['1.6T/3.2T NPO/CPO Optical Engines Optical/Electrical Hybrid Packaging Platforms']} titleIn={'NPO/CPO ELSFP & OE Connectivity'} titleout={'Pluggable Transceiver'}></CardProducts>
                    </div>
                </Col>
                <Col xl={24} xxl={8} >
                    <div className='card_item'>
