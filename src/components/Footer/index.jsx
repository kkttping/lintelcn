...
export default function Footer() {
  ...
  return (
    <div className="com_footer">
      ...
      >
        <VerticalAlignTopOutlined style={{ fontSize: "20px", color: "#fff" }} />
      </div>
      <div className="pc">
        <div className="top">
      ...
      <div className="ph">
        <div className="link" onClick={() => toPage("products")}>
          Products
        </div>
        <div className="link" onClick={() => toPage("technology")}>
          Technology
        </div>
        <div className="link" onClick={() => toPage("company")}>
          Company
        </div>
        <div className="link" onClick={() => toPage("career")}>
          Career
        </div>
        <div className="link" onClick={() => toPage("contact")}>
          Contact
        </div>
        <ul style={{ listStyle: "none" }} class="share">
          <li>
            <a
              href="https://www.linkedin.com/company/linktel/"
              class="icon-linkedin iconfont"
            >
              <LinkedinOutlined style={{ fontSize: "30px" }} />
            </a>
          </li>
          <li>
            <a
              href="http://www.linkteltech.com/index.php?r=site%2Fcontact#firve"
              class="icon-youxiang1 iconfont"
            >
              <MediumOutlined style={{ fontSize: "30px" }} />
            </a>
          </li>
          <li>
            <a
              href="http://www.linkteltech.com/index.php?r=site%2Fcontact#one"
              class="icon-dingwei1 iconfont"
            >
              <EnvironmentOutlined style={{ fontSize: "30px" }} />
            </a>
          </li>
          <li>
            <a
              href="http://www.linkteltech.com/index.php?r=site%2Fcontact"
              class="icon-dianhua iconfont"
            >
              <PhoneOutlined style={{ fontSize: "30px" }} />
            </a>
          </li>
